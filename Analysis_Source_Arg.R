...
#write.csv(photo_visual,file= "photo_visual_dataframe.csv")
...
ggsave(filename = "plot1.pdf",plot =plot1, device="pdf")



#list with most abundant CATAMI categories
#filter by stata and site
photo_visual_long_strata <- subset(photo_visual_long,strata=="LOWTIDE" & site=="PUNTA LOMA")
...
#Correlations
correlations <- read.csv("correation_matrix.csv")
