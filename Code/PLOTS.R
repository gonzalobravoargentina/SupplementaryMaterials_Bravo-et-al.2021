...
Coverdata_abundant <- subset(Coverdata_abundant,Comments!="PQ.Robot.bycountry")
...
ggsave(here("Figures", "Fig_2.bis.pdf"),width =10,height =8)
ggsave(here("Figures", "Fig_2.bis.png"),width =10,height =8)

#BOXPLOT FG
PQ_VQ_long.FG <- subset(PQ_VQ_long.FG,Comments!="PQ.Robot.bycountry")
